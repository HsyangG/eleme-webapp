      ...
      <div v-show="showFlag" class="food" ref="food">
        <div class="food-content">
          ...
          <div class="content">
            ...
            <div class="detail">
              <span class="sell-count">月售P{{food.sellCount}}份</span><span class="rating">好评率{{food.rating}}%</span>
            </div>
            <div class="price">
          ...
          <div class="rating">
            <h1 class="title" v-show="food.ratings">商品评价</h1>
            ...
            <div class="rating-wrapper">
              <ul v-show="food.ratings && food.ratings.length">
                <li v-show="needShow(rating.rateType, rating.text)" v-for="rating in food.ratings" :key="rating.id" class="rating-item">
                  ...
                  <p class="text">
                    <span :class="{'icon-praise_fill':rating.rateType===0, 'icon-praise':rating.rateType===1}"></span>{{rating.text}}
                  </p>
                </li>
              </ul>
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    methods: {
      show() {
        this.showFlag = true;
        this.selectType = ALL; // 每次初始化都显示全部
        this.onlyContent = false; // 每次初始化都显示全部评论
        this.$nextTick(() => {
          if (!this.scroll) {
